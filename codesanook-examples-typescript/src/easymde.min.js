...
},{"typo-js":15}],3:[function(require,module,exports){
...
},{"../../lib/codemirror":9}],4:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"../../addon/mode/overlay":6,"../../lib/codemirror":9,"../markdown/markdown":11}],11:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"codemirror":9}],17:[function(require,module,exports){
'use strict';
var CodeMirror = require('codemirror');
        ...
        if (this.options && this.options.renderingConfig && this.options.renderingConfig.codeSyntaxHighlighting === true) {
            ...
            if (hljs) {
                markedOptions.highlight = function (code, lang) {
                    var highlightCode = lang
                        ? hljs.highlight(lang, code, false).value
                        : hljs.highlightAuto(code).value;

                    return '<div class="hljs">' + highlightCode + '</div>';
                };
            }
        }
