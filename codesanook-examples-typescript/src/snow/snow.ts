...
const MAX_PATH_HEIGHT = window.innerHeight;
...
class SnowFlake {
    ...
    constructor(public imageElement: HTMLImageElement) {
        ...
        this.imageElement.src = 'snowflake.png';
        this.reset();
    }
    ...
    private reset() {
        ...
        const startY = random(0, MAX_PATH_HEIGHT) * -1;// * -1 To start above browser window, top with negative value. 
        this.x = this.startX; 
        this.y = startY;
